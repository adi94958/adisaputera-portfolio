...
export const TimelineItem: React.FC<TimelineItemProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className={`absolute md:left-1/2 md:transform md:-translate-x-1/2 left-4 transform -translate-x-1/2 top-6 w-4 h-4 ${dotColor} rounded-full border-4 border-white dark:border-gray-800 z-10 shadow-lg`} />
      ...
      <div className={`md:w-5/12 w-full ${
        ...
        <div
          className={`absolute top-8 ${
            isLeft ? "md:right-0 md:w-8 right-10 w-6" : "md:left-0 md:w-8 right-10 w-6"
          } h-0.5 ${lineColor}`}
        />
      </div>
    </motion.div>
