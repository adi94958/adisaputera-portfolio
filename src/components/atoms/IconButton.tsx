...
export const IconButton: React.FC<IconButtonProps> = ({
  ...
  const baseStyles =
    "inline-flex items-center justify-center rounded-full focus:outline-none focus:ring-0 disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  const variants = {
    ...
    ghost:
      "text-secondary-700 dark:text-secondary-300 hover:bg-secondary-100/80 dark:hover:bg-secondary-800/80 backdrop-blur-sm border border-transparent hover:border-secondary-200 dark:hover:border-secondary-700 focus:ring-primary-500",
  };
