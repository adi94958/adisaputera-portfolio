...
export const SECTION_TITLES = {
  ...
  PROFESSIONAL_JOURNEY: "My Professional Journey",
} as const;
...
export const EMPTY_STATE_MESSAGES = {
  ...
  NO_EXPERIENCE: "No Experience Available",
  NO_EXPERIENCE_DESC: "Work experience will appear here once they are added",
  NO_EDUCATION: "No Education Available",
  NO_EDUCATION_DESC: "Education records will appear here once they are added",
